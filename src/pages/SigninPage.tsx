...
function GoogleIcon({ className = "" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="#EA4335"
        d="M12 10.2v3.9h5.4c-.2 1.2-1.6 3.6-5.4 3.6-3.3 0-6-2.7-6-6s2.7-6 6-6c1.9 0 3.1.8 3.8 1.5l2.6-2.5C16.8 3.1 14.6 2 12 2 6.5 2 2 6.5 2 12s4.5 10 10 10c5.8 0 9.6-4.1 9.6-9.9 0-.7-.1-1.2-.2-1.7H12z"
      />
      <path
        fill="#FBBC05"
        d="M12 22c2.6 0 4.8-.9 6.4-2.4l-3-2.5c-.8.5-1.9.9-3.4.9-2.7 0-5-1.8-5.8-4.3l-3.3 2.5C4.6 19.7 8 22 12 22z"
      />
      <path
        fill="#4285F4"
        d="M21.6 12.1c0-.7-.1-1.2-.2-1.7H12v3.9h5.4c-.2 1.2-1.6 3.6-5.4 3.6-2.7 0-5-1.8-5.8-4.3l-3.3 2.5C4.6 19.7 8 22 12 22c5.8 0 9.6-4.1 9.6-9.9z"
      />
    </svg>
  );
}
function FacebookIcon({ className = "" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="#1877F2"
        d="M24 12a12 12 0 10-13.9 11.9v-8.4H7.1V12h3V9.4c0-3 1.8-4.7 4.6-4.7 1.3 0 2.7.2 2.7.2v3h-1.5c-1.5 0-2 1-2 2V12h3.4l-.5 3.5H14v8.4C19.6 23.1 24 18.1 24 12z"
      />
    </svg>
  );
}
...
function PrimaryButton(props: React.ButtonHTMLAttributes<HTMLButtonElement>) {
  ...
  return (
    <button
      className={`w-full h-10 inline-flex items-center justify-center rounded-xl bg-[#333333] text-white px-4 text-sm  hover:bg-[#333333] ${className} font-poppins`}
      {...rest}
    >
      {children}
    </button>
...
function InputWithIcon({
  ...
  const effectiveType =
    isPwd && withVisibilityToggle ? (show ? "text" : "password") : type;
      ...
      <section className="bg-white px-5 sm:px-16 md:px-9 lg:px-16 xl:px-24 pb-12 flex flex-col">
        ...
        <div className="flex-1 grid place-items-center mt-10 md:mt-16">
          <div className="w-full max-w-[420px] lg:max-w-[480px] text-center md:text-left">
            <h1 className="text-[28px] leading-[34px] font-semibold text-gray-900">
              Sign in
            </h1>
